              ...
              <div className="card-block login-form-box checkout-page-style">
                ...
                {error
                  ...
                  && <span className="error d-block">
                    ...
                    <div className="col-12 d-flex justify-content-center mt-1"><button type="submit" class="col-4 btn bg-gradient-primary text-white " fdprocessedid="llsprm"> <a href="https://sr7shipspares.com/" style={{color:'white'}}>Go Back </a></button></div>
                  </span>
                }
              </div>
            </div>

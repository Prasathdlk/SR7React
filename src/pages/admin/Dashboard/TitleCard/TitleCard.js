          ...
          <Link to="/sendviewquote/s">
            <div className="widget quick-category" >
              ...
              <div className="quick-category-content d-flex flex-md-column flex-row justify-content-md-center justify-content-lg-start justify-content-xl-start justify-content-center gap-md-0 gap-2">
                ...
                <p className="mytext-primary mb-0 d-flex justify-content-md-center justify-content-lg-start justify-content-xl-start justify-content-center" style={{ fontWeight: "700",fontSize:"15px"  }}>Quotes Sent</p>
              </div>
            </div>
          </Link>
        </div>
          ...
          <Link to="/sendviewquote/r">
            <div className="widget quick-category">
              ...
              <div className="quick-category-content d-flex flex-md-column flex-row justify-content-md-center justify-content-lg-start justify-content-xl-start justify-content-center gap-md-0 gap-2">
                ...
                <p className="mytext-warning mb-0 d-flex justify-content-md-center justify-content-lg-start justify-content-xl-start justify-content-center" style={{ fontWeight: "700",fontSize:"15px" }}>Quotes Received</p>
              </div>
            </div>
          </Link>
        </div>
          ...
          <Link to="/spotlightsubmission">
            <div className="widget quick-category" >
              ...
              <h3 className='d-flex justify-content-md-center justify-content-lg-start justify-content-xl-start justify-content-center'>{dashWidgets?.data?.submitted_spotlight}</h3>
                <p className="mytext-secondary mb-0 d-flex justify-content-md-center justify-content-lg-start justify-content-xl-start justify-content-center" style={{ fontWeight: "700",fontSize:"15px" }}> Spotlights Submission</p>
              </div>
            </div>
          </Link>
        </div>
          ...
          <Link to="/documents">
            <div className="widget quick-category " >
              ...
              <div className="quick-category-content d-flex flex-md-column flex-row justify-content-md-center justify-content-lg-start justify-content-xl-start justify-content-center gap-md-0 gap-2">
                ...
                <p className="mytext-success-teal mb-0 d-flex justify-content-md-center justify-content-lg-start justify-content-xl-start justify-content-center" style={{ fontWeight: "700",fontSize:"15px"  }}>Documents</p>
              </div>
            </div>
          </Link>
        </div>

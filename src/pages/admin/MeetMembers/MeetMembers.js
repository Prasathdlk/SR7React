              ...
              <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Form.Group className="mb-4 mt-3" controlId="exampleForm.ControlInput1">
                  <div className="d-flex flex-row">
                    ...
                    <Form.Label className='px-1'>Members</Form.Label>
                  </div>
                  <Form.Control
                    type="text"
                    placeholder="Members"
                ...
                <Modal.Footer >
                  ...
                  {updateEvent
                    && <Modal.Title className='px-2'
                      onClick={handleShow}
                    >
                      <Button className='cancel' style={{ fontSize: "12px" }}>
                  ...
                  {updateEvent
                    ...
                    && <Modal.Title className='px-2'
                      ...
                      <Button className='success' style={{ fontSize: "12px" }}>
                        Accept Meeting
                      </Button>
                    </Modal.Title>
                  }
  ...
  return (
    <div style={{ color: '#1b4d70', fontWeight: "800" }}>
      ...
      {eventInfo.event.extendedProps.logged_in_member_id === eventInfo.event.extendedProps.member_id
        ...
        && <div className="meetTitle1"><p className='parameet'>Requested Members has <br />changed the time<br /></p></div>}

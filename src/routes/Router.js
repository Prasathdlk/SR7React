...
import SigninWordpress from "pages/auth/SigninWordpress";
    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/signin-wordpress" element={<PublicRoutes component={SigninWordpress} />} />
          ...
          <Route path="/sr7spotlights/:stype?" element={<ProtectedRoutes component={TalaSpotlights} index="7"/>} />
          ...
          <Route path="/sr7spotlights/details/:id" element={<ProtectedRoutes component={SpotlightDetails} index="19" />} />
          <Route path="/announcements/details/:id/:d?" element={<ProtectedRoutes component={AnnouncementDetails} index="20" />} />
          <Route path="/exhibitions/attendees" element={<ProtectedRoutes component={EventAttendees} index="21" />} />
